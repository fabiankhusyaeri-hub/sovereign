...
<head>
    ...
    <title>Forgot Password - SOVEREIGN</title>
    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-card">
            ...
            <div style="text-align: center; margin-bottom: 24px;">
                ...
                <h2 style="font-family: 'Cormorant', serif; font-size: 26px; color: #ffffff; font-weight: 300; margin: 0 0 8px;">
                    Reset Password
                </h2>
                <p style="font-size: 11px; color: #888888; line-height: 1.6; margin: 0;">
            ...
            @if (session('status'))
                <div style="background: rgba(196,160,98,0.15); border: 1px solid var(--gold, #c4a062); color: var(--gold, #c4a062); padding: 10px; font-size: 11px; text-align: center; margin-bottom: 20px;">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <div style="margin-top: 24px; padding-top: 20px; border-top: 1px solid rgba(196,160,98,0.15); text-align: center;">
                <a href="{{ route('login') }}" style="color: #666666; font-size: 11px; text-decoration: none; letter-spacing: 0.1em; transition: color 0.3s;">
                    &larr; Back to Login
                </a>
            </div>
