  ...
  <script>
    ...
    const servicesData = {
      warranty: {
        ...
        content: `
          <p>Every watch <strong>Sovereign</strong> covered by an official international warranty for 5 years from the date of purchase.</p>
          <p><strong>Warranty Coverage Includes:</strong></p>
          <ul style="padding-left: 20px; margin: 0;">
            <li>Repair & re-calibration of movement accuracy (COSC Standard).</li>
            <li>Replacement of defective internal components.</li>
            <li>Re-inspection & water resistance testing (5-10 ATM).</li>
          </ul>
          <p>Service can be performed at all authorized service centers in Bandung, Jakarta, and Surabaya.</p>
        `
      },
      authentication: {
        tag: "AUTHENTICATION",
        ...
        content: `
          <p>Each Sovereign unit is equipped with a physical <strong>Certificate of Authenticity</strong> signed by the CEO and a unique serial number (Serial Number) engraved on the watch caseback.</p>
          <p>We guarantee 100% authenticity of the 316L Stainless Steel material, anti-reflective Sapphire Crystal glass, and the official certification of the Alligator Leather strap.</p>
        `
      },
      shipping: {
        ...
        content: `
          <p>We provide shipping services with full-value insurance to ensure the safety of your watch during transit.</p>
          <ul style="padding-left: 20px; margin: 0;">
            <li><strong>Domestic Shipping:</strong> Free shipping to all regions in Indonesia using priority courier (1-3 business days).</li>
            <li><strong>Showroom Pickup:</strong> You can choose the Pre-Order option and pick up the unit directly at the Boutique in Bandung, Jakarta, or Surabaya.</li>
          </ul>
        `
      },
      privacy: {
        ...
        content: `
          <p>Sovereign values your privacy and the confidentiality of your personal data. All information you provide when registering for an appointment, pre-ordering, or subscribing to our newsletter will be stored securely.</p>
          <p>Your data will never be sold or shared with third parties outside the scope of service processing and exclusive communication with the Sovereign Circle.</p>
        `
      },
      terms: {
        ...
        content: `
          <p>By accessing this website and making a booking or appointment reservation, you agree to the terms and conditions applicable to Sovereign Horlogerie.</p>
          <ul style="padding-left: 20px; margin: 0;">
            <li>Allocation of *Limited Edition* units is processed based on the order of reservation confirmation (first-come, first-served).</li>
            <li>Showroom visit schedules can be changed up to 24 hours before the agreed appointment time.</li>
          </ul>
        `
      }
    };
